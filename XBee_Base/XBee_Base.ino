...
void setup() {
  ...
  // initalize xbee
  int XbeeStatus = InitXBee(XBee_MY_Addr, XBee_PAN_ID, Serial1);
  if (!XbeeStatus) {
...
void loop() {
  ...
  BytesRead900 = Serial3.readBytes(Buff_9002XbeeBuf+BytesinBuffer, Serial3.available());
